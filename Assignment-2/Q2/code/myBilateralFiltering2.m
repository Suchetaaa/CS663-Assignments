function [output, spatial_mask] = myBilateralFiltering2(input, std_space, std_intensity)
...
%std_space = 1 ;   %%%%%%%add standard deviation pertaining to space   
%std_intensity = 1;%%%%%%add standard deviation pertaining to intensity
windowsize = 15;
